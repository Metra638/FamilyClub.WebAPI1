        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SerieTitle = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubMemberId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ClubMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishingDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ...
                    ItemsInSet = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Languages_OriginalLanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageProduct", x => new { x.LanguagesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_LanguageProduct_Languages_LanguagesId",
                        column: x => x.LanguagesId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LanguageProduct_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAuthors", x => new { x.AuthorsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductAuthors_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAuthors_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSeries", x => new { x.ProductsId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_ProductSeries_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductsId = table.Column<int>(type: "integer", nullable: false),
                    TranslatorsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTranslators", x => new { x.ProductsId, x.TranslatorsId });
                    table.ForeignKey(
                        name: "FK_ProductTranslators_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTranslators_Translator_TranslatorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_ClubMemberId",
                        column: x => x.ClubMemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageProduct_ProductsId",
                table: "LanguageProduct",
                column: "ProductsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ClubMemberId",
                table: "Orders",
                column: "ClubMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAuthors_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_OriginalLanguageId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslators_TranslatorsId",
                table: "ProductTranslators",
                column: "TranslatorsId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ClubMemberId",
                table: "Reviews",
                column: "ClubMemberId");
